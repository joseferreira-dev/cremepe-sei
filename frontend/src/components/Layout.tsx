...
const navItems: NavItem[] = [
  ...
  { path: '/processos/sem-resumo', label: 'Sem Resumo', icon: <MenuIcon d="M12 9v3m0 4h.01M9 19a7 7 0 116-6.99V13a1 1 0 002 0v-.01A9 9 0 1012 21c-1 0-2-.25-3-.99h0" /> },
  ...
  { path: '/administracao', label: 'Administração', icon: <MenuIcon d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31-8.26 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z" />, roles: ['admin'] },
