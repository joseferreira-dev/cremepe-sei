...
const navItems: NavItem[] = [
  ...
  { id: 'processes-sem-resumo', label: 'Sem Resumo', icon: <MenuIcon d="M12 9v3m0 4h.01M9 19a7 7 0 116-6.99V13a1 1 0 002 0v-.01A9 9 0 1012 21c-1 0-2-.25-3-.99h0" /> },
  { id: 'new-process', label: 'Cadastrar Processo', icon: <MenuIcon d="M12 4v16m8-8H4" /> },
